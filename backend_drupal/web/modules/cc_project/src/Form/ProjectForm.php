...
namespace Drupal\cc_project\Form;
...
class ProjectForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($result == SAVED_NEW) {
      ...
      $this->logger('cc_project')->notice('Created new project %label', $logger_arguments);
    }
    else {
      $this->messenger()->addStatus($this->t('The project %label has been updated.', $message_arguments));
      $this->logger('cc_project')->notice('Updated new project %label.', $logger_arguments);
    }
